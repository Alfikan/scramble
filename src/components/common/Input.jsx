...
const Input = React.forwardRef(
  (
    ...
    const inputClasses = cn(
      ...
      "font-medium text-black transition-all duration-300 ease-smooth",
      "placeholder:text-gray-100 placeholder:transition-all placeholder:duration-300",
          ...
          {(rightIcon || isPassword) && (
            <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
              {isPassword ? (
                ...
                <div className="text-muted-gray">{rightIcon}</div>
              )}
            </div>
          )}
        </div>
